...
import com.sy.dictionary.KnowledgeDictionaryApplication;
...
@SpringBootTest(classes = KnowledgeDictionaryApplication.class)
public class SpringbootElasticsearchApplicationTests {
    ...
    public void isIndexExist() {
        try {
            System.out.println(esDao.isIndexExist("en-us"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void findById(){
        String index="ch-en";  //必须为小写
        String type="data";
        String id="frzqK2cBNWm8E6m3VQrq";
        ...
        Map<String, DocumentField> map=res.getFields();
    }
